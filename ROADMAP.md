# Capability Agent Roadmap (open items)
...
they land, so CA-N references keep resolving (CHANGELOG.md remains the record of
what landed).

## Item format

Each work item is a `### CA-N: Title` heading followed by a field block and free
